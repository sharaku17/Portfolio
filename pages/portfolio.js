        ...
        <div className="w-full mx-auto md:mt-16 max-w-screen-2xl">
          <div className="grid  grid-cols-3  overflow-hidden">
              ...
              <ul>
                ...
                >
                  <div className="secondary-t">
                    ...
                    <div className=" font-bold    mt-6">
                      <span className=" text-4xl uppercase">Portfolio</span>{" "}
                      <br></br>
                ...
                >
                  <div>
                    ...
                    <div className=" font-normal text-lg  mt-2"> 2021-2022</div>
                  </div>
                </motion.li>
              </ul>
            </div>
            <motion.a
              ...
              transition={{ duration: 0.8, delay: 1 }}
              href="https://github.com/sharaku17/portfolio"
              className="portfoliomockup mt-12 md:mt-0 h-64 md:h-5/6  col-span-3 md:col-span-2 bg-cover bg-center  md:ml-16 "
            ...
            <motion.div
              ...
              whileInView={{ translateY: "0px", opacity: 1 }}
              transition={{ duration: 0.8 }}
              className="thisisatest2 mt-12 md:mt-0 h-64 md:h-screen  col-span-3  bg-cover bg-center   "
            ></motion.div>
          </div>
        </div>
      </div>
