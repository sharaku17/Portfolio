      ...
      <section class="w-full">
        ...
        >
          <a class="flex flex-col">
            ...
            <span class=" text-5xl md:text-7xl "> Contact me</span>{" "}
          </a>
        </motion.h2>
        <motion.p
        ...
        <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
          <div class="space-y-12">
            ...
            >
              ...
              <input class="w-full border text-black border-input-border bg-input px-4 py-4" />
            </motion.div>
            <motion.div
              initial={{ y: 200, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
            ...
            >
              ...
              <input
                type="email"
                class="w-full border text-black border-input-border bg-input px-4 py-4"
              />
            </motion.div>
            <motion.div
              initial={{ y: 200, opacity: 0 }}
            ...
            >
              ...
              <textarea
                type="email"
                class="w-full border text-black border-input-border bg-input px-4 py-4 h-56 resize-none"
              ></textarea>
            </motion.div>
            <motion.button
              initial={{ y: 200, opacity: 0 }}
