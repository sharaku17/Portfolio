...
const heroText = {
  hidden: { opacity: 1, translateX: "-500px" },
...
const Hero = () => {
  ...
  return (
    <div className="relative max-w-screen-2xl mx-auto ">
      <div className="w-64 md:w-96  lg:w-120 mt-0 absolute  right-2  mx-auto   md:mt-0 -z-1">
      ...
      <div class="container mt-32  md:mt-20  flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div class="flex flex-wrap md:flex-nowrap ">
          <motion.nav
            ...
            initial="hidden"
            animate="visible"
            className="   lg:mr-24 lg:w-4  right-0 bottom-10 fixed  hidden lg:block "
            data-scroll
            data-scroll-sticky
          ...
          >
            <div class="  transform ">
              <motion.a
                ...
                href="#"
                className="nav-dot selected-circle block w-12 h-12  rounded-full border-2 border-nav "
              >
                <svg
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            class="flex flex-wrap  justify-start md:justify-start relative max-w-xl mt-0 md:my-36 "
          >
            <div class="box flex flex-col space-y-4 justify-center">
              <div class="title overflow-hidden  width-full relative h-14 my-2 md:h-60 items-center">
                {/* <motion.div
                  variants={mainBlock}
                  custom={0}
                  initial="hidden"
                ...
                <span className="font-bold text-xl md:text-6xl lg:text-7xl logo-text ">
                  <motion.h1 variants={heroText} transition={{ duration: 1.3 }}>
              ...
              <div class="role width-full overflow-hidden relative my-4 h-20 items-center">
                {/* <motion.div
                  variants={mainBlock}
                  custom={2}
                  initial="hidden"
              ...
              <div className="role relative width-full   h-12 ">
                <motion.div
                  variants={heroText}
                  initial={{ opacity: 0, translateX: "-500px" }}
