...
const pathVariant = {
  ...
  visible: {
    ...
    transition: {
      ...
      strokeWidth: { duration: 5, ease: [1, 0, 0.8, 1] },
    },
  },
};
...
const Hero = () => {
  ...
  async function sequence() {
    await animation.start({ scale: 0.8 });
    await animation.start({ scale: 1.1 });
    await animation.start({ rotate: 1 });
  ...
  return (
    <div>
      <div class="container mt-16  flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div class="flex flex-wrap md:flex-nowrap ">
          <nav className="inline-block lg:mr-24 lg:w-4 fixed left-percentage hidden xl:block ">
            <div class="absolute left-50 transform  -translate-x-1/2 space-y-6 mt-52">
              ...
              <a
                href="#"
                className="nav-dot block w-5 h-5 rounded-full border-2 border-nav opacity-40 bg-body"
              >
                <span className="bg-black px-2 py-1 rounded-md ml-10 opacity-0">
                  Work
                </span>
          ...
          <div class="flex flex-wrap lg:ml-20 justify-start md:justify-start max-w-xl mt-0 md:my-36 ">
            <h1 className="font-bold text-5xl md:text-6xl lg:text-7xl text-left md:text-left">
              Danilo Trotta <br />{" "}
            ...
            <div class="w-full flex justify-start md:justify-start">
              <motion.button
                animate={animation}
                onLoad={sequence}
                className="px-4 py-2 text-white bg-gradient-to-br from-gradient_blue to-gradient_indigo  rounded-md font-bold mt-12 flex items-center space-x-3"
              >
                <span>My work</span>
                <div>
                  <svg
        ...
        <div className="w-64 md:w-96  lg:w-120 mt-0  absolute right-2 md:mt-0 md:right-20 lg:right-40 xl:right-64 -z-1">
        ...
        <div className="flex flex-col w-14 absolute right-4 space-y-12 text-gray-200 ">
