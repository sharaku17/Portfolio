  ...
  return (
    <header className="py-6   ">
      ...
      >
        ...
        <div className="nav flex space-x-12 ">
          <Link href="/home">
            <motion.a
            ...
            >
              <div className="flex group">
                <svg
                  className=" opacity-50 group-hover:opacity-100 group-hover:scale-110 transform group-hover:-translate-x-2 transition-all ease-in"
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
                  viewBox="0 0 24 24"
                  width="24px"
